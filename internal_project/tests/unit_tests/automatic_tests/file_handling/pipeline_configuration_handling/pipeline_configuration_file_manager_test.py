...
class MyTestCase(unittest.TestCase):
    def test_load_with_all_attributes_set(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            pipeline_configuration_data: PipelineConfigurationData = (
                PipelineConfigurationFileManager.load_from_file(temp_file)
            )
            ...
            self.assertEqual(
                'Version("1.0.0")',
                pipeline_configuration_data.supported_program_version,
            )
            self.assertEqual(
            ...
            self.assertEqual(
                {"extra_value": "True"}, pipeline_configuration_data.additional_values
            )
    ...
    def test_load_empty_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(
                None, pipeline_configuration_data.supported_program_version
            )
    ...
    def test_dictionary_names_as_keys(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(
                {"additional_values": "5"},
                pipeline_configuration_data.additional_values,
            )
