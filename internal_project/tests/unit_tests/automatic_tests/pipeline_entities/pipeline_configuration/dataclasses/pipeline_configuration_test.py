...
class InitPipelineConfiguration(unittest.TestCase):
    ...
    def test_all_attributes_correctly_set(self):
        ...
        self.assertEqual(
            Version("1.0.3"), pipeline_configuration.supported_program_version
        )

        dummy_info: PipelineComponentInfo = ComponentRegistry.get_component("dummy")

        node_0_value: PipelineComponentInstantiationInfo = (
            PipelineComponentInstantiationInfo("0", dummy_info, {"property1": "value1"})
        )
        node_1_value: PipelineComponentInstantiationInfo = (
            PipelineComponentInstantiationInfo("1", dummy_info, {})
        )
        node_2_value: PipelineComponentInstantiationInfo = (
            PipelineComponentInstantiationInfo("2", dummy_info, {"property2": "value2"})
        )

        node_0: DirectionalAcyclicGraphNode[PipelineComponentInstantiationInfo] = (
            DirectionalAcyclicGraphNode(node_0_value)
        )
        node_1: DirectionalAcyclicGraphNode[PipelineComponentInstantiationInfo] = (
            DirectionalAcyclicGraphNode(node_1_value)
        )
        node_2: DirectionalAcyclicGraphNode[PipelineComponentInstantiationInfo] = (
            DirectionalAcyclicGraphNode(node_2_value)
        )

        expected_graph: DirectionalAcyclicGraph[PipelineComponentInstantiationInfo] = (
            DirectionalAcyclicGraph()
        )
        ...
        self.assertEqual(
            {"test1": Tree(None)}, pipeline_configuration.additional_values
        )
    ...
    def test_only_required_attributes_set(self):
        ...
        node_0_value: PipelineComponentInstantiationInfo = (
            PipelineComponentInstantiationInfo("0", dummy_info, {})
        )
        node_1_value: PipelineComponentInstantiationInfo = (
            PipelineComponentInstantiationInfo("1", dummy_info, {})
        )
        node_2_value: PipelineComponentInstantiationInfo = (
            PipelineComponentInstantiationInfo("2", dummy_info, {})
        )
