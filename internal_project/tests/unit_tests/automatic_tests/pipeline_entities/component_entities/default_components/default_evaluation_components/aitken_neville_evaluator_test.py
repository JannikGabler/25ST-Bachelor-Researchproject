...
class PerformAction(unittest.TestCase):
    def test_something(self):
        ...
        for node_count in range(4, 100):
            ...
            for i, evaluation_point in enumerate(result_data.interpolant_evaluation_points):
                expected_result: float = evaluation_point ** 3 - evaluation_point

                self.assertAlmostEqual(expected_result, result_data.interpolant_values[i], places=1)
