...
class InitFromString(unittest.TestCase):
    ...
    def test_two_nodes_with_no_edges(self):
        ...
        expected.add_node(
            DirectionalAcyclicGraphNode(
                ("node1", "Type1", {"property1": "value1", "property2": "value2"})
            )
        )
        expected.add_node(
            DirectionalAcyclicGraphNode(
                ("node2", "Type1", {"property1": "value3", "property2": "value4"})
            )
        )
    ...
    def test_two_nodes_with_predecessors(self):
        ...
        expected: DirectionalAcyclicGraph = DirectionalAcyclicGraph()
        node1: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node1", "Type1", {"property1": "value1", "property2": "value2"})
        )
        node2: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node2", "Type1", {"property1": "value3", "property2": "value4"})
        )
    ...
    def test_large_graph(self):
        ...
        node1: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node1", "Type6", {"property1": "value1"})
        )
        node2_1: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node2.1", "Type7", {"property2": "value2"})
        )
        node2_2: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node2.2", "Type9", {})
        )
        node3_1: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node3.1", "Type41691", {})
        )
        node3_2: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node3.2", "Type26", {"property2": "value2"})
        )
        node4: DirectionalAcyclicGraphNode = DirectionalAcyclicGraphNode(
            ("node4", "Type126", {"property3": "value3"})
        )
