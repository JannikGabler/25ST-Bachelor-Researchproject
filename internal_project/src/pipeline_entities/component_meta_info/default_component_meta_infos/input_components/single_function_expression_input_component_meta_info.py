...
single_function_expression_input_component_meta_info: ComponentMetaInfo = ComponentMetaInfo(
    attributes_modifying={"function_values"},

    dynamic_constraints=[InputKeyRequiredConstraint("single_function_expression"),
