...
from pipeline_entities.pipeline.component_entities.component_meta_info.defaults.plot_components.run_time_plot_component_meta_info import run_time_component_meta_info
...
class RunTimePlotComponent(InterpolationCore):
    ...
    def perform_action(self) -> PipelineData:
        ...
        interpolant_reports = [report for report in execution_reports if issubclass(report.component_instantiation_info.component.component_type, InterpolationCore)
                               and report.component_instantiation_info.component.component_id.lower() != "run time plotter"]
        ...
        for report in interpolant_reports:
            component_cls = (report.component_instantiation_info.component.component_class)
