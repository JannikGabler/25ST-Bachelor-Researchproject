...
class RelativeRoundOffErrorPlotComponent(InterpolationCore):
    ...
    def perform_action(self) -> PipelineData:
        template: PlotTemplate = RelativeRoundOffErrorPlotComponentUtils.plot_data(self._pipeline_data_, self._additional_execution_info_)

        if RelativeRoundOffErrorPlotComponentConstants.SHOW_PLOT_IN_SEPARATE_PROCESS:
