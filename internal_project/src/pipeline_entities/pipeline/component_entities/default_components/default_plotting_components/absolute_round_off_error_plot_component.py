...
from pipeline_entities.pipeline.component_entities.component_meta_info.defaults.plot_components.absolute_round_off_error_plot_component import \
    absolut_round_off_error_plot_component_meta_info
...
@pipeline_component(id="absolute round off error plotter", type=PlotComponent, meta_info=absolut_round_off_error_plot_component_meta_info)
