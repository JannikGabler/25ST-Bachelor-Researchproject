...
from functions.defaults.default_interpolants.fft_interpolant import (
    FastFourierTransformationInterpolant,
)
...
@pipeline_component(
    id="fft interpolation",
    type=InterpolationCore,
    meta_info=fft_interpolation_core_meta_info,
)
