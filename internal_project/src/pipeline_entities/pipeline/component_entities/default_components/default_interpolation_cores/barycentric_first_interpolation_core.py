...
from pipeline_entities.pipeline.component_entities.component_meta_info.defaults.interpolation_cores.barycentric_first_interpolation_core_meta_info import barycentric_first_interpolation_core_meta_info
