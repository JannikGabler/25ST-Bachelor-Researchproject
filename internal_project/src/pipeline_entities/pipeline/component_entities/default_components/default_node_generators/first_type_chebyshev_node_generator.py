...
@pipeline_component(
    id="chebyshev1 node generator",
    type=NodeGenerator,
    meta_info=first_type_chebyshev_node_generator_meta_info,
)
    ...
    def _create_compiled_callable_(
        ...
        def _internal_perform_action_() -> jnp.ndarray:
            ...
            def rescale_nodes():
                ...
                new_length = jnp.asarray(
                    interpolation_interval[1] - interpolation_interval[0],
                    dtype=data_type,
                )
