...
"""
Component meta information for the function expression input component. 
This component modifies the attribute original_function and allows it to be overridden. 
It has pre-dynamic constraints that require the keys function_expression and sympy_function_expression_simplification to be provided in the pipeline input, 
while it has no post-dynamic constraints. 
...
function_expression_input_component_meta_info: ComponentMetaInfo = ComponentMetaInfo(
    ...
    pre_dynamic_constraints=[InputKeyRequiredConstraint("function_expression"), InputKeyRequiredConstraint("sympy_function_expression_simplification")],
