...
class CompiledInterpolant:
    ...
    ### Constructor ###
    ###################
    def __init__(self, compiled_jax_callable: callable, required_evaluation_points_shape: tuple[int],
                 used_data_type: DTypeLike) -> None:
    ...
    def evaluate(self, evaluation_points: jnp.ndarray) -> jnp.ndarray:
        if evaluation_points.shape != self._required_evaluation_points_shape_:
            raise InvalidArgumentException(f"This {repr(self.__class__.__name__)} was compiled for the shape "
        ...
        if evaluation_points.dtype != self._used_data_type_:
            raise InvalidArgumentException(f"This {repr(self.__class__.__name__)} was compiled for the data type "
    ...
    def __repr__(self) -> str:
        return (f"{self.__class__.__name__}(compiled_jax_callable={repr(self._compiled_jax_callable_)}, "
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, self.__class__):
            ...
            return (self._compiled_jax_callable_ is other._compiled_jax_callable_
                    and self._required_evaluation_points_shape_ == other._required_evaluation_points_shape_
