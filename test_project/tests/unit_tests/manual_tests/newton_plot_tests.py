...
def plot_sin_example():
    ...
    plt.plot(evaluation_points, jnp.sin(evaluation_points), '--', label="Originalfunktion sin(x)", color='green')
    plt.scatter(interpolation_nodes, function_values, color='red', label="Stützpunkte")
    plt.title("f(x) = sin(x) auf [0, 1.5]")
    plt.legend()
    plt.grid(True)
    plt.show()
...
def plot_quadratic_example():
    ...
    plt.plot(evaluation_points, interpolated_values, label="Newton-Interpolation", color='blue')
    plt.plot(evaluation_points, true_values, '--', label="Originalfunktion f(x)", color='green')
    plt.scatter(interpolation_nodes, function_values, color='red', label="Stützpunkte")
    plt.legend()
...
def plot_exp_example():
    ...
    plt.plot(evaluation_points, interpolated_values, label="Newton-Interpolation", color='blue')
    plt.plot(evaluation_points, true_values, '--', label="Originalfunktion exp(x)", color='green')
    plt.scatter(interpolation_nodes, function_values, color='red', label="Stützpunkte")
...
def plot_log_example():
    ...
    plt.plot(evaluation_points, interpolated_values, label="Newton-Interpolation", color='blue')
    plt.plot(evaluation_points, true_values, '--', label="Originalfunktion log(x+1)", color='green')
    plt.scatter(interpolation_nodes, function_values, color='red', label="Stützpunkte")
