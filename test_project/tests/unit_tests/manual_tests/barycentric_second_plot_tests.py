...
def plot_sin_example():
    ...
    plt.plot(
        evaluation_points,
        interpolated_values,
        label="Baryzentrische Interpolation 2. Art",
    )
    plt.plot(
        evaluation_points,
        jnp.sin(evaluation_points),
        "--",
        label="Originalfunktion sin(x)",
    )
...
def plot_log_example():
    ...
    plt.plot(
        ...
        f(evaluation_points),
        "--",
        label="Originalfunktion log(x+1)",
        color="green",
    )
    plt.scatter(interpolation_nodes, function_values, color="red", label="Stützpunkte")
