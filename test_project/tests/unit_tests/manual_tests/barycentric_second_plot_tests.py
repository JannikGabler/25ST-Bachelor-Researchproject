...
from test_project.src.barycentric_second.barycentric_second import barycentric_type2_interpolate
...
def plot_sin_example():
    ...
    plt.plot(evaluation_points, interpolated_values, label="Baryzentrische Interpolation 2. Art")
...
def plot_quadratic_example():
    ...
    plt.plot(evaluation_points, interpolated_values, label="Baryzentrische Interpolation 2. Art", color='blue')
