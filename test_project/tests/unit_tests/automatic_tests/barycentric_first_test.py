...
from test_project.src.barycentric_first.barycentric_first import (
    barycentric_type1_interpolate,
)
...
class MyTestCase(unittest.TestCase):
    ...
    def test_exact_interpolation_points(self):
        ...
        for node, true_value in zip(interpolation_nodes, function_values):
            interpolated_value = barycentric_type1_interpolate(
    ...
    def test_constant_function(self):
        ...
        interpolated_values = barycentric_type1_interpolate(
